                  ...
                  {ch.submittedReceiptPublicId ? (
                    <div className="p-4 rounded-xl bg-[var(--warning-soft)] border border-[var(--warning-border)] text-[var(--warning-foreground)] text-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center justify-center px-3 py-1.5 rounded-lg bg-[var(--surface-subtle)] hover:bg-[var(--surface-hover)] border border-[var(--border-default)] text-[var(--text-primary)] font-semibold text-xs transition-colors shrink-0"
                      >
