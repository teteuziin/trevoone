        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-zinc-600 mt-0.5">
              Acompanhe suas tarefas, envie entregas e confira o status de aprovação.
            </p>
          </div>
        </div>
        ...
        {items.length === 0 ? (
          <div className="bg-white rounded-2xl border border-zinc-200 p-10 text-center space-y-3 shadow-sm">
            ...
            <p className="text-sm text-zinc-500 max-w-md mx-auto">
              Você ainda não possui missões em andamento. Quando a equipe da consultoria criar uma nova missão para você, ela aparecerá aqui.
            </p>
          </div>
        ) : (
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between pt-4 border-t border-zinc-200 text-sm">
            ...
            <div className="flex gap-2">
              {page > 1 && (
                <Link
                  href={`/consultoria/${slug}/missoes?page=${page - 1}`}
