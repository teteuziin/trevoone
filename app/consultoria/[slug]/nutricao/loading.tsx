...
export default function StudentNutricaoLoading() {
  return (
    <div
      ...
      aria-busy="true"
      aria-label="Carregando plano alimentar"
    >
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto p-4 sm:p-6 lg:p-8 pb-[calc(5.5rem+env(safe-area-inset-bottom,0px))] md:pb-8 space-y-6">
        ...
        <div className="p-6 sm:p-7 rounded-3xl border border-[var(--border-default)] bg-[var(--surface)] shadow-xs space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="space-y-2">
              ...
              <Skeleton className="h-4 w-48 sm:w-72 rounded-md" />
            </div>
        ...
        <div className="space-y-4">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="p-5 sm:p-6 rounded-2xl border border-[var(--border-default)] bg-[var(--surface)] shadow-xs space-y-4"
            >
