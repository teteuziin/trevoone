      ...
      <main className="min-h-dvh w-full flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 pt-[calc(2rem+env(safe-area-inset-top,0px))] pb-[calc(2rem+env(safe-area-inset-bottom,0px))] bg-[var(--surface-canvas)] text-[var(--text-primary)]">
        <div className="w-full max-w-[480px] mx-auto flex flex-col items-center space-y-6 my-auto">
          ...
          <div className="w-full space-y-3">
            ...
            <Link
              href="/admin"
              className="group block w-full p-4.5 sm:p-5 rounded-2xl border border-[var(--border-default)] hover:border-[var(--brand-border)] bg-[var(--surface-card)] hover:bg-[var(--surface-subtle)] shadow-xs hover:shadow-card hover:-translate-y-0.5 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand)] min-h-[44px]"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3.5 min-w-0">
                  <div className="w-11 h-11 rounded-xl bg-[var(--brand-surface)] border border-[var(--brand-border)] flex items-center justify-center shrink-0 p-1 shadow-2xs">
                ...
                <ChevronRightIcon className="w-5 h-5 text-[var(--text-tertiary)] group-hover:text-[var(--brand)] group-hover:translate-x-0.5 transition-all shrink-0 pl-1" />
              </div>
            </Link>
          ...
          <div className="w-full pt-1 flex flex-col sm:flex-row gap-2.5">
            <Link
              ...
              className="flex items-center justify-center flex-1 py-2.5 px-4 rounded-xl text-xs font-semibold text-[var(--text-secondary)] hover:text-[var(--text-primary)] bg-[var(--surface-card)] hover:bg-[var(--surface-subtle)] border border-[var(--border-default)] shadow-xs transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand)] min-h-[44px]"
            >
              Conta e segurança
            </Link>
            <LogoutButton
      ...
      <main className="min-h-dvh w-full flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 bg-[var(--surface-canvas)] text-[var(--text-primary)]">
        <div className="w-full max-w-[420px] mx-auto flex flex-col items-center space-y-6">
          ...
          <EmptyState
            ...
            className="w-full bg-[var(--surface-card)] border-[var(--border-default)] rounded-2xl"
          />
        </div>
      </main>
    );
