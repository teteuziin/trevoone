...
export function BrandWallpaper() {
  return (
    ...
    >
      ...
      {/* 2. Padrão Vetorial Contínuo (Trevo One Grid) */}
      <svg
        className="absolute inset-0 w-full h-full transition-opacity duration-300"
        style={{
          color: "var(--wallpaper-pattern-color, #18181b)",
          opacity: "var(--wallpaper-pattern-opacity, 0.045)",
        }}
        xmlns="http://www.w3.org/2000/svg"
      >
        <defs>
          <pattern
            id="trevo-brand-wallpaper-grid"
            width="130"
            height="130"
            patternUnits="userSpaceOnUse"
          >
            {/* Micro-pontos nos vértices da grade */}
            <circle cx="0" cy="0" r="1" fill="currentColor" />
            <circle cx="130" cy="0" r="1" fill="currentColor" />
            <circle cx="0" cy="130" r="1" fill="currentColor" />
            <circle cx="130" cy="130" r="1" fill="currentColor" />

            {/* Linhas finas estruturais / guia sutil */}
            <line
              x1="0"
              y1="65"
              x2="130"
            ...
            {/* Símbolo central: Trevo de 4 folhas equilibrado */}
            <g transform="translate(65, 54)">
              {/* Pétala Norte */}
              <path
                d="M 0,0 C -5.5,-6 -8,-14 0,-16.5 C 8,-14 5.5,-6 0,0"
                fill="currentColor"
                opacity="0.9"
              />
              {/* Pétala Leste */}
              <path
                d="M 0,0 C 6,-5.5 14,-8 16.5,0 C 14,8 6,5.5 0,0"
                fill="currentColor"
                opacity="0.9"
              />
              {/* Pétala Sul */}
            ...
            {/* Micro-tipografia institucional: TREVO ONE */}
            <text
              x="65"
              y="86"
              textAnchor="middle"
        ...
        <rect width="100%" height="100%" fill="url(#trevo-brand-wallpaper-grid)" />
      </svg>
