      ...
      <div className="bg-[var(--surface)] border border-[var(--border-strong)] rounded-3xl p-6 sm:p-7 shadow-xs space-y-5 border-specular-t depth-surface">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold text-[var(--text-primary)] bg-[var(--surface-subtle)] hover:bg-[var(--surface-hover)] border border-[var(--border-default)] transition-all shrink-0 shadow-2xs depth-interactive min-h-[40px]"
          >
