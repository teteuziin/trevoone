                ...
                {joinAccess?.allowed ? (
                  <div className="space-y-1">
                    <button
                      ...
                      disabled
                      aria-disabled="true"
                      className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm bg-[var(--brand)] text-white opacity-90 cursor-not-allowed shadow-sm transition-all"
                    >
                      <svg className="w-4 h-4 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.2">
