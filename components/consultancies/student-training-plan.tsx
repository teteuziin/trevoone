        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-100 pb-4">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-bold bg-emerald-50 text-[#00A859] border border-emerald-200">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <a
              ...
              download
              className="inline-flex items-center justify-center gap-1.5 px-4 py-2 bg-zinc-900 hover:bg-zinc-800 text-white text-xs sm:text-sm font-semibold rounded-xl shadow-xs transition-all cursor-pointer"
            >
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 text-xs text-zinc-500">
          {(plan.startsOn || plan.endsOn) && (
            <div className="flex items-center gap-1.5">
              ...
              <span>
                Vigência: <strong className="text-zinc-700">{plan.startsOn ? new Date(plan.startsOn + "T00:00:00").toLocaleDateString("pt-BR") : "Início"}</strong> até <strong className="text-zinc-700">{plan.endsOn ? new Date(plan.endsOn + "T00:00:00").toLocaleDateString("pt-BR") : "Indeterminado"}</strong>
              </span>
            </div>
          )}
          {plan.activatedAt && (
